...
For internal macOS team distribution, see [`macos/README.md`](macos/README.md). It documents the bundled app workflow built around `make macos-dist`, including CLI bundling at `Contents/Resources/slack-status`, ad-hoc signing by default, and DMG-based teammate installation.
